        ...
        <div class="row">
            ...
            <div id="container" class="clearfix">
                ...
                <!--{if $arrPageLayout.LeftNavi|@count > 0}-->
                    <div id="" class="col-lg-3 col-md-3 col-sm-3 visible-lg visible-md visible-sm">
                        <!--{* ▼左ナビ *}-->
                ...
                <div id="" <!--{**}-->
                    class="
                        ...
                        <!--{/if}-->
                        <!--{if $arrPageLayout.LeftNavi|@count == 0 && $arrPageLayout.RightNavi|@count == 0}-->
                        <!--{" col-lg-12 col-md-12 col-sm-12"}-->
                        <!--{elseif $arrPageLayout.LeftNavi|@count != 0 && $arrPageLayout.RightNavi|@count != 0}-->
                        <!--{" col-sm-6"}-->
                        <!--{else}-->
                        <!--{" col-sm-9"}-->
                        <!--{/if}-->
                ...
                <!--{if $arrPageLayout.RightNavi|@count > 0}-->
                    <div id="" class="col-lg-3 col-md-3 visible-lg visible-md">
                        <!--{* ▼右ナビ *}-->
            ...
            <!--{if $arrPageLayout.FooterBottomNavi|@count > 0}-->
                <div id="footerbottomcolumn col-sm-12">
                    <!--{* ▼上ナビ *}-->
